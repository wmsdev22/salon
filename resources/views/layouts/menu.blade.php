...
@can('memberships.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('memberships*') ? 'active' : '' }}" href="{!! route('memberships.index') !!}">@if($icons)
                <i class="nav-icon fas fa-folder-open"></i>@endif<p>{{trans('lang.membership_plural')}}</p></a>
    </li>
@endcan
